...
import tnut.searchengine.helper.Util;
...
public class IndexService {
    ...
    private static final List<String> INDICES = List.of(Indices.DART_INDEX);
    ...
    public void recreateIndices(final boolean deleteExisting) {
        final String settings = Util.loadAsString("static/es-setting.json");
